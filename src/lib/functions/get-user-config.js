...
function getUserConfig(projectBaseDirectory: string, callback: Function)
{
    ...
    try
    {
        ...
        const coreConfigFilename = path.join(projectBaseDirectory, "statyck-config", "statyck-config.json");
        ...
        const themeConfigFilename = path.join(projectBaseDirectory, "statyck-config", "theme-config.json");
